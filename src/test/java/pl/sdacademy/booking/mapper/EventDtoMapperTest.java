...
class EventDtoMapperTest {
    ...
    void shouldMapEventEntityToEventDto() {
        ...
        eventEntity.setFrom(LocalDateTime.of(2023, Month.SEPTEMBER, 13, 12, 00, 00));
        ...
        assertThat(eventDto.getFromTime()).isEqualTo(LocalDateTime.of(2023, Month.SEPTEMBER, 13, 12, 00, 00));
        assertThat(eventDto.getToTime()).isEqualTo(LocalDateTime.of(2023, Month.SEPTEMBER, 13, 12, 50, 00));
    }
